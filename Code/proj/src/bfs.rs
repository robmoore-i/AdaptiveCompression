...
pub fn bfs_example_test<F>(mut bfs: F) where F: FnMut(Vec<i64>, Vec<i64>, i64) -> Vec<i64> {
    let n = 30 as i64;
    let src = vec![24, 22, 29, 3, 15, 15, 2, 13, 26, 20, 1, 21, 27, 29, 2, 18, 28, 26, 7, 26, 25, 29, 19, 29, 23, 29, 29, 4, 29, 10, 21, 4, 14, 29, 5, 28, 13, 2, 29, 14, 6, 11, 29, 18, 8, 12, 24, 9, 25, 24, 17, 16, 11, 20, 22, 26, 30, 29];
    let dst = vec![3, 23, 15, 24, 16, 29, 4, 8, 21, 9, 21, 1, 25, 6, 28, 22, 2, 29, 4, 28, 14, 26, 29, 11, 22, 30, 19, 7, 13, 11, 26, 2, 29, 17, 29, 26, 29, 12, 20, 25, 29, 29, 14, 24, 13, 2, 26, 20, 27, 18, 29, 15, 10, 29, 18, 24, 29, 5];
    let start_node = 10;
