...
the graph by modifying the existing cracking algorithms presented by Ideos' et al.. This subsection
contains terms we used in our modification of the cracking algorithm which will be used throughout the
remainder of this chapter to make it easier to follow.

We will speak generally of cracking applied to arrays.
